...
public class Questions extends JFrame implements ActionListener {
  ...
  public void runMathGUI(){
   ...
   //Background Label Config
    ImageIcon gradient = new ImageIcon("images/Pure-CSS3-Gradient-Background-Animation.gif");
  ...
  public void clear(){
    ...
    mathQuestion.remove(back);
    //mathQuestion.remove(next);
  }
